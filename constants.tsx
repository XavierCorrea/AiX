...
export const SERVICES_DATA = [
  {
    ...
    features: [
      ...
      "Perfect for professional firm intake"
    ],
    icon: <Icons.Phone />
  },
  {
    title: "Integrated AI Assistants",
    description: "Your digital presence should be your best employee. We build modern, conversion-optimized assistants.",
    features: [
      "Integrated AI assistants",
      "Specialized high-converting landing pages",
...
export const FAQS = [
  ...
  {
    question: "Can you help my high-growth service business?",
    answer: "Yes! We specialize in complex service industries where operational excellence is key. Our AI systems are trained to handle intake with precision and professionalism, ensuring every potential client is qualified and scheduled according to your rules."
  },
  {
